...
class Teacher(models.Model):
    DEPARTMENT = [
        ...
        ('BCT', 'Bachelor of comp engg'),
        ('BEI', 'Bachelor of Electronics and Information'),
        ('BCE', 'Bachelor of CIVIL ENGG'),
    ...
    semester = models.CharField(max_length=5, choices=DEPARTMENT, default='N/A', null=True, blank=True)
    phone_no = models.IntegerField( null=False, blank=False)
...
class Assignment(models.Model):
    ...
    full_mark = models.CharField(max_length=100, blank=False, null=False)
