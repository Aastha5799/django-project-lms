    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semester', models.CharField(blank=True, choices=[('BCA', 'Bachelor of Computer Application'), ('BCT', 'Bachelor of comp engg'), ('BEI', 'Bachelor of Electronics and Information'), ('BCE', 'Bachelor of CIVIL ENGG')], default='N/A', max_length=5, null=True)),
                ('phone_no', models.IntegerField()),
